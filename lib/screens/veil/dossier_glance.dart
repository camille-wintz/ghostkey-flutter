...
import '../../ui/text.dart';
import 'gmc_grid.dart';

/// The dossier's at-a-glance grid.
///
/// A CHARACTER's is the GMC — goal, motivation, conflict, arc, each external
/// and internal — drawn by `GmcGrid`. Anything else keeps the model's own
/// labels and the phrase-length
